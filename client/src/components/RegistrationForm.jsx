    ...
    return (
        <form onSubmit={onSubmitHandler} className="my-2 flex flex-col justify-center [&>*]:text-md text-white ">
            ...
            <p className='flex my-3'>
                ...
                <input className='border-2 border-slate-300 rounded w-full basis-2/3 md:basis-3/4  text-black' type="password" onChange={(e) => changeHandler(e)} value={user.password} name="password" />
            </p>
            <p className='flex my-3'>
                <label className="basis-1/3  font-bold ">Confirm Password: </label>
                <input className='border-2 border-slate-300 rounded w-full basis-2/3 md:basis-3/4  text-black' type="password" onChange={(e) => changeHandler(e)} value={user.confirmPassword} name="confirmPassword" />
            </p>
